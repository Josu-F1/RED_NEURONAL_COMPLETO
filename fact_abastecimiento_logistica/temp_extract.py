...
print(f"Target 'y_desempeno_entrega' agregado. Distribución original:")
...
class_names_map = {0: 'Insatisfactoria (0)', 1: 'Aceptable (1)', 2: 'Excelente (2)'}
...
# Load existing meta
meta_path = r"c:\Users\Marlon\Documents\Sexto\BI\MiProyecto\RED_NEURONAL_COMPLETO\fact_abastecimiento_logistica\outputs\inference_model.json"
