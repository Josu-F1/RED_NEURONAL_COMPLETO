...
print("Target 'y_desempeno' agregado. Distribución original:")
...
class_names = ['Bajo Desempeño (0)', 'Desempeño Medio (1)', 'Alto Desempeño (2)']
...
plt.suptitle('Análisis de Dispersión y Separabilidad - Proveedores', 
